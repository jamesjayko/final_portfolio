(function() {
  ...
  $(function() {
    $(".jamesko_portrait").on({
      mouseenter: function() {
        $(this).attr("src", "assets/img/jamesko_port.jpg");
      },
      mouseleave: function() {
        $(this).attr("src", "assets/img/jamesko_bw_port.jpg");
      }
    });
  });
  ...
  function initMailer() {
    ...
    $(".js-Mailer")
      ...
      .on("submit", function(e) {
        ...
        $.post("../../php_mailer/mail_handler.php", $form.serialize())
          .done(function(r) {
            var $rHolder = $form.find(".js-Response");
            var response = JSON.parse(r);
            if (response.success) {
              console.log("what is r?", typeof response);
              console.log("whatis response", response);
